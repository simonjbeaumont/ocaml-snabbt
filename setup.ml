...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9e595c60170dd55d8a0e2d46877a87ae) *)
(*
...
let setup_t =
  {
                    ...
                    (OASISExpr.EBool true,
                      Some
                        (("ln",
                           [
                              "-sf";
                              "../../_build/examples/simple/simple.js";
                              "examples/simple/simple.js"
                           ])))
                 ]
            };
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples/simple";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           FindlibPackage ("js_of_ocaml", None);
                           FindlibPackage ("js_of_ocaml.syntax", None);
                           InternalLibrary "snabbt";
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\154\224i\190\230\022\238\021\027\027\198\164\135~\252\180";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
